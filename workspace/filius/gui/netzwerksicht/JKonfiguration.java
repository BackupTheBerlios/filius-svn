...
public class JKonfiguration extends JBackgroundPanel {
	...
	private void initKonfigPanel() {
		...
		minimierenButton.setBounds(0, 0, minimierenButton.getIcon()
				.getIconWidth(), minimierenButton.getIcon().getIconHeight());
	...
	public void aenderungenAnnehmen() {
		Main.debug.println("INVOKED ("+this.hashCode()+") "+getClass()+" (JKonfiguration), aenderungenAnnehmen()");
	}
