...
public class SMTPClient extends ClientAnwendung implements I18n {
	/**
	 * Die Anwendung, die diesen SMTP-Client verwendet (das kann eine
	 * EmailAnwendung zum Versand einer erstellten Nachricht oder ein
	 * EMailServer zur Weiterleitung einer empfangenen Nachricht sein)
	 */
	...
	private boolean schickeMailFrom(String absender) throws Exception {
		...
		if (EingabenUeberpruefung.isGueltig(absender, EingabenUeberpruefung.musterEmailAdresse)) {
