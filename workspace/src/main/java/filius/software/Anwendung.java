...
public abstract class Anwendung extends Thread {
	...
	/*
	 * method for downward compatibility; older versions of filius possibly used
	 * this method, such that some saved scenarios depend on it! ... or maybe
	 * only JAVA demands properties to be set by a "set" method! (required by
	 * XMLDecoder)
	 */
