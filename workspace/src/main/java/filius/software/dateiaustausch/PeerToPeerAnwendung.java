 ...
 * <ul>
 * <li>Der Server verarbeitet alle eingehenden Anfragen von anderen Teilnehmern.
 * Und veranlasst gegebenenfalls die Weiterleitung von Ping-, Pong- und
 * Query-Nachrichten sowie die Verarbeitung von eingehenden HTTP-GET-Anfragen.</li>
