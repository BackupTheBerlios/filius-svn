 ...
 * eine Verbindung.</li>
 * <li>Der Verbindungsaufbau erfolgt durch Aufruf der Methode
 * <b>verbinden()</b>. Diese Methode blockiert so lange, bis der
 * Verbindungsaufbau erfolgreich abgeschlossen werden konnte oder eine Ausnahme
 * ausgeloest wurde. Der Verbindungsaufbau erfolgt mit einem
 ...
 * ESTABLISHED ist.</li>
 * <li>Wenn eine Verbindung erfolgreich aufgebaut werden konnte, ist es moeglich
 * Nachrichten mit der Methode <b>sende(String)</b> an den entfernten Socket zu
 * verschicken. Diese Methode blockiert, bis die Nachricht erfolgreich
 ...
 * <b>empfangen()</b> auf eine eingehende Nachricht gewartet werden. Es wird ein
 * String zurueck gegeben, wenn die Nachricht vollstaendig empfangen wurde.</li>
...
public class TCPSocket extends Socket implements Runnable {
	 ...
	 * abgeschlossen ist, oder eine VerbindungsException ausgeloest wurde. <br />
	 ...
	 * @throws VerbindungsException
	 *             - wird geworfen, wenn beim Aufruf keine Verbindung
	 *             hergestellt ist
	 * @throws TimeOutException
