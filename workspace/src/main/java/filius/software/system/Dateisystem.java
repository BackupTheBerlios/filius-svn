 ...
 * Daher werden die einzelnen Verzeichnisse und Dateien als Knoten gespeichert. <br />
 * Dateien werden als Objekte der Klasse Datei uebergeben, die als Inhalt sowohl
 * einfache Textdateien wie auch Base64-kodierte binaere Dateien ermoeglicht. <br />
...
public class Dateisystem implements Serializable {
	 ...
	 * 
	 * @param verzeichnis
	 *            Verzeichnisknoten, in dem nach einem Kinderknoten gesucht
	 *            werden soll
	 * @param pfad
	 *            der absolute Verzeichnis- oder Dateipfad als String
	 * @return der Knoten im Verzeichnisbaum, der durch durch den uebergebenen
	...
	public static String evaluatePathString(String path) {
		...
		while (tk.hasMoreTokens()) {
			...
			} // current directory is referenced again by "."; ignore this path
			  // element
	...
	// add root node denomination again to path representation (if not existing
	// already)
