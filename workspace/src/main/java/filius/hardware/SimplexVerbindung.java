...
public class SimplexVerbindung implements Runnable {
	 ...
	 * @param verbindung
	 *            - Verbindung, auf der die einseitige Kommunikation gestartet
	 *            wird
	 * 
	 *            Dieser Konstruktor wird innerhalb der Verbindung aufgerufen
	 *            und in einem Thread gestartet. Davon gibt es zwei
	 *            Verbindungen, die die bidirektionale Verbindung zwischen den
	 *            beiden Hardwares herstellt.
	 */
	...
	/**
	 * @author carsten Diese run-Methode des Threads (nur Runnable!) sorgt fuer
	 *         die einzelnen Kommunikationen auf einer Verbindung in beide
	 *         Richtungen
	 */
	public void run() {
