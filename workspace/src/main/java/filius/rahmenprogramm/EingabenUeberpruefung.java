 ...
 * Pattern zur Verfuegung, z.B. fuer IP-Adressen oder Klassen-Namen. Mit diesen
 * Pattern wird die Funktion isGueltig aufgerufen, die den String auf ein Muster
 * prueft.
 * 
...
public class EingabenUeberpruefung implements I18n {
	...
	public static final Pattern musterEmailAdresse = Pattern.compile("^"
	        ...
	        + // start choice
	        "[a-z A-Z0-9\\-_\\.]* <"
	        + // address with name, beginning; Name part
	        ...
	        // ")"+ // end boundary
	        "$");
	public static final Pattern musterEmailAdresseExt = Pattern
	...
	/**
	 * Die Funktion isGueltig bekommt einen String und ein Muster (Vorzugsweise
	 * ein Muster, dass in der Klasse EingabenUeberpruefung vorgegeben ist)
	 * Moeglicher Aufruf: isGueltig(ipAdresse,
